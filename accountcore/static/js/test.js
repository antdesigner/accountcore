...
odoo.define('accountcore.DataExport', ['web.core', 'web.crash_manager', 'web.framework', 'web.py_utils', 'web.DataExport'], function (require) {
    ...
    var acExport = dataExport.extend({
        ...
        export: function (export_format) {
            ...
            this.ids_to_export = self.record.domain ? false : idsToExport;
...
// 猴子补丁，改变基类，
odoo.define('accountcore.basechange', ['web.AbstractField','web.ListController','accountcore.DataExport'], function (require) {
    ...
    var voucherListController = ListController.extend({
        ...
        renderButtons: function () {
            ...
            if (this.$buttons) {
                ...
                var btn_excel = new list2excel(this, "voucher2excel");
